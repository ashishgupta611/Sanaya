...
export default function CourseCard({ course, enrolled = false, progress = 0 }: CourseCardProps) {
  ...
  return (
    <Card className="hover:shadow-lg transition duration-200 overflow-hidden">
      <img
        src={course.thumbnail || "https://images.unsplash.com/photo-1498050108023-c5249f4df085?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=240"}
        alt={course.title}
      ...
      <CardContent className="p-6">
        ...
        {enrolled && (
          <div className="mb-4">
            <div className="flex justify-between items-center mb-2">
              ...
              <span className={`text-sm font-medium ${progress === 0 ? 'text-gray-400' :
        ...
        <div className="flex items-center justify-between">
          ...
          <Link href={`/courses/${course.id}`}>
            <Button
              className={enrolled ? "bg-primary hover:bg-blue-700" : "bg-secondary hover:bg-purple-700"}
            >
